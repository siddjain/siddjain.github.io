...
Vazirani in his https://www.youtube.com/watch?v=VPsl_5RQe1A&list=PLnhoxwUZN7-6hB2iWNhLrakuODLaxPTOG[videos] talks about the action of the unitary matrix as rotating the Hilbert space 
but that is a simplification to aid in teaching. A unitary matrix can do more than rotation in general.
...
and variable stem:[x] enumerates the stem:[2^n] pure states. The circuit leaves the stem:[|-\rangle] unchanged and "`messes up`" input superposition. 
