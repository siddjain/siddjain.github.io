...
A very insightful way to understand quantum teleportation is provided by following equation which expresses the 3 qubit system (Alice's qubit +
...
X, Z, or XZ], depending on the outcome of Alice’s measurement.
...
* https://www.youtube.com/playlist?list=PLDAjb_zu5aoFazE31_8yT0OfzsTcmvAVg[Umesh Vazirani Quantum Computing Course]